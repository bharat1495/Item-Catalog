...
def new_menu_item(restaurant_id):
    ...
    if login_session['user_id'] != restaurant.user_id:
        return "< script > function myFunction()" \
               "{alert('You are not authorize to add menu items to this . " \
               "'Please create your own restaurant in order to add items.')}" \
               "< / script > < body onload = 'myFunction()' >"
    if request.method == 'POST':
        newItem = MenuItem(name=request.form['name'], price=request.form[
...
def edit_Menu_Item(restaurant_id, menu_id):
    ...
    if login_session['user_id'] != restaurant.user_id:
        return "< script > function myFunction()" \
               ...
               "of this restaurant." \
               "'Please create your own restaurant to edit items.')}" \
               "< / script > < body onload = 'myFunction()' >"
    if request.method == 'POST':
        if request.form['name']:
...
def delete_Menu_Item(restaurant_id, menu_id):
    ...
    if login_session['user_id'] != restaurant.user_id:
        return "< script > function myFunction()" \
               "{alert('You are not authorized to delete menu items from it " \
